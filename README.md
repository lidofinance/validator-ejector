...
| VOTING_WITHDRAWAL_TRANSACTIONS_ALLOWLIST      | No       | ["0x123"]             | Allowed transactions to withdrawal validator via voting (For example, to verify Aragon voting withdrawal), without lido oracle participation                                                                                                            | 
| EASY_TRACK_ADDRESS                            | Yes      | 0x123                 | Easy track contract address                                                                                                                                                                                                                             |
